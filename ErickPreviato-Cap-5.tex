...
utilizando estratégias de \textit{Transfer Learning} com modelos de linguagem baseados em \textit{Transformers}.

Os resultados obtidos demonstraram que a utilização de modelos de linguagem pré-treinados em português, 
