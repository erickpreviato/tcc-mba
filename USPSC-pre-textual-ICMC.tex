...
\titulo{Análise de sentimentos em avaliações de disciplinas: um estudo de caso no ensino superior} 
\titleabstract{Sentiment analysis in subject evaluations: a case study in higher education}
\tituloadic{Sentiment analysis in subject evaluations: a case study in higher education}
\tituloresumo{Análise de sentimentos em avaliações de disciplinas: um estudo de caso no ensino superior}
...
\autorficha{Previato, Erick Vansim}
\autorabr{PREVIATO, E. V.}
...
\orientadoradic{Advisor: Prof. Dr. Wallace Correa de Oliveira Casaca}
\orientadorcorpoficha{orientador Wallace Correa de Oliveira Casaca}
\orientadorficha{Casaca, Wallace Correa de Oliveira, orient}
...
%Nota de autorização quando o idioma for o Português		
...
%Nota de autorização quando o idioma for o Inglês
